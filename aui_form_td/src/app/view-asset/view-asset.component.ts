...
*/
  viewAsset() {
    ...
    // code here
    this.assetService.getAssetDetails(this.assetId).subscribe(asset => {
      if (null != asset){
...
*/
  update() {
    //  code here
    //[routerLink]="['/updateAsset',assetDetails.assetId ]"
    this.assetService.authenticate = true;
    this.router.navigate(['/updateAsset',this.assetDetails.assetId ]);
  }
